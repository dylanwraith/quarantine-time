...
public class AuthorRecord extends UpdatableRecordImpl<AuthorRecord> implements Record4<Integer, String, String, String> {

    private static final long serialVersionUID = 400354332;
    ...
    /**
     * Setter for <code>author.address</code>.
     */
    ...
    /**
     * Getter for <code>author.address</code>.
     */
    ...
    @Override
    public AuthorRecord values(Integer value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuthorRecord(Integer id, String firstName, String lastName, String address) {
        super(Author.AUTHOR);
